            ...
            <section className="mb-16">
              ...
              <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl p-6 border border-green-400/20">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-white/70 font-light leading-relaxed">
                      <strong className="text-green-300">Key Takeaway:</strong> Steve demonstrates that amateur observers and citizen scientists 
                      can make groundbreaking discoveries that professional researchers might miss, highlighting the importance of 
