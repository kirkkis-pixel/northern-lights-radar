      ...
      <div className="py-24 bg-gradient-to-b from-slate-900 to-black">
        <div className="max-w-7xl mx-auto px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            {/* Blog Article 5 */}
            <Link href="/aurora-lab/blog/aurora-climate-change" className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-yellow-400/30 hover:bg-white/10 transition-all duration-500 hover:scale-105">
              ...
              <h3 className="text-xl font-light text-white mb-3 group-hover:text-yellow-300 transition-colors">
                Aurora and Climate Change Impact
              </h3>
              <p className="text-white/70 font-light leading-relaxed mb-4">
                How climate change affects aurora visibility and what the future holds for aurora viewing.
              </p>
              <div className="flex items-center justify-between text-sm text-white/50">
